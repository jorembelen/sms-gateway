...
<body class="bg-background text-on-surface" x-data="{ sidebarOpen: false }">
        ...
        <nav class="flex-1 px-4 mt-2 space-y-1 overflow-y-auto custom-scrollbar">
            <a
                ...
                @class([
                    ...
                    'text-primary bg-secondary-container font-bold' => request()->routeIs('admin.dashboard'),
                    'text-on-surface-variant hover:bg-surface-container-high hover:text-primary' => ! request()->routeIs('admin.dashboard'),
                ])
            >
            ...
            <a
                ...
                @class([
                    'flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors duration-200 ease-in-out',
                    'text-primary bg-secondary-container font-bold' => request()->routeIs('admin.messages'),
                    'text-on-surface-variant hover:bg-surface-container-high hover:text-primary' => ! request()->routeIs('admin.messages'),
                ])
            >
            ...
            <a
                ...
                @class([
                    'flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors duration-200 ease-in-out',
                    'text-primary bg-secondary-container font-bold' => request()->routeIs('admin.devices'),
                    'text-on-surface-variant hover:bg-surface-container-high hover:text-primary' => ! request()->routeIs('admin.devices'),
                ])
            >
            ...
            <a
                href="{{ route('admin.failed') }}"
                @class([
                    'flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors duration-200 ease-in-out',
                    'text-primary bg-secondary-container font-bold' => request()->routeIs('admin.failed'),
                    'text-on-surface-variant hover:bg-surface-container-high hover:text-primary' => ! request()->routeIs('admin.failed'),
                ])
            >
    ...
    <div class="lg:ml-[280px] min-h-screen flex flex-col">
        ...
        {{-- Top bar --}}
        <header class="sticky top-0 right-0 z-30 flex justify-between items-center w-full px-6 h-16 bg-surface border-b border-outline-variant">
